...
namespace MixedRealityToolkit.UX.AppBarControl
{
    public class AppBar : InteractionReceiver
    {
        ...
        private void RefreshTemplates ()
        {
            ...
            if (UseRemove)
            {
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Remove, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
            }
            //AS
            if (UseReset)
            {
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Reset, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
            }
            //
            if (UseAdjust)
            {
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Adjust, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Done, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
            }
            if (UseHide)
            {
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Hide, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
                defaultButtonsList.Add(GetDefaultButtonTemplateFromType(ButtonTypeEnum.Show, numCustomButtons, UseHide, UseAdjust, UseRemove, UseReset));
            }
        ...
        /// <returns></returns>
        private static ButtonTemplate GetDefaultButtonTemplateFromType(ButtonTypeEnum type, int numCustomButtons, bool useHide, bool useAdjust, bool useRemove, bool useReset)
        {
            ...
            switch (type)
            {
                ...
                case ButtonTypeEnum.Reset:
                    return new ButtonTemplate(
                        ...
                        "Reset",
                        "ObjectCollectionDefault", // Replace with your custom icon texture name in HolographicButton prefab
                        "Reset",
                        3,
                        2);
                //
